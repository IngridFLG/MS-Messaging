package org.restaurante.msmensajeria.infrastructure.configuration.util;
...
import static org.restaurante.msmensajeria.infrastructure.configuration.Constants.EMPLOYEE_ROLE_ID;
...
public class JwtAuthorizationFilter extends OncePerRequestFilter {
    ...
    static {
        rolesEndpointsMap.put("ROLE_" + EMPLOYEE_ROLE_ID, Arrays.asList("/twilio", ""));
    }
